            ...
            var exports = function() {
               ...
               HemiLight.prototype = {
                  init: function(hex1, hex2) {
                     ...
                     this.obj = new THREE.HemisphereLight(
                        this.hex1,
                        this.hex2,
                        this.intensity
                     );
      ...
      6: [
         function(require, module, exports) {
            ...
            var initThree = function() {
               ...
               if (!firstRenderer) {
                  alert("Three.js is missing");
               }
               firstRenderer.setSize(body_width, body_height);
               canvas.appendChild(firstRenderer.domElement);
               firstRenderer.setClearColor(0x000000, 1.0);

               firstScene = new THREE.Scene();
               firstScene.fog = new THREE.Fog(0x000000, 800, 1600);
            ...
            var buildPoints = function() {
               ...
               tx_grad = tx_ctx.createRadialGradient(
                  100,
                  100,
                  20,
                  100,
               ...
               for (var i = 0; i < movers_num; i++) {
                  var mover = new Mover();
                  var range =
                     Math.log(Util.getRandomInt(2, 256)) / Math.log(256) * 250 +
                     50;
               ...
               firstScene.add(points);
               firstScene.add(points2);
            };
               ...
               for (var i = 0; i < movers.length; i++) {
                  ...
                  if (mover.is_active) {
                     ...
                     if (mover.position.y > 1000) {
                        var range =
                           Math.log(Util.getRandomInt(2, 256)) /
                              Math.log(256) *
                              250 +
                           50;
                        var rad = Util.getRadian(Util.getRandomInt(0, 180) * 2);
            ...
            var buildTextPlate = function() {
               ...
               textplate = new THREE.Mesh(
                  textplate_geometry,
                  textplate_material
               );
               textplate.position.y = 200;
               textplate.rotation.set(
                  Util.getRadian(-90),
                  0,
                  Util.getRadian(90)
               );
               firstScene.add(textplate);
            };
            ...
            var raycast = function(vector) {
               ...
               intersects = raycaster.intersectObjects(firstScene.children);
            };
            ...
            var render = function() {
               ...
               updatePoints();
               //rotateCamera();
               firstRenderer.render(firstScene, camera.obj);
            };
